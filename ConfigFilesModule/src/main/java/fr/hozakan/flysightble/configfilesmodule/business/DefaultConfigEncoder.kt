...
import fr.hozakan.flysightble.configfilesmodule.business.parser.UNIT_SYSTEM_INDICATOR
    ...
    override fun encoreConfig(configFile: ConfigFile): String {
        return buildString {
            appendLine("""
                ...
                ; $FILENAME_INDICATOR${configFile.name}
                ; $UNIT_SYSTEM_INDICATOR${configFile.unitSystem.value}
